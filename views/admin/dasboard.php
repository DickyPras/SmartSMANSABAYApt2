    ...
    <div class="max-w-md mx-auto bg-primary min-h-screen relative shadow-2xl overflow-hidden">
        ...
        <div class="bg-body-bg rounded-t-[3rem] min-h-[70vh] px-6 pt-16 relative -mt-10">
            ...
            <div class="pt-2 pb-10">
                <a href="../user/auth/login.php" class="w-full inline-flex items-center justify-center gap-2 bg-white text-gray-900 font-semibold px-4 py-3 rounded-2xl shadow-sm hover:bg-gray-100 transition">
